...
%
% Function written by T.   , University of Ljubljana (October 2014)
...
%Dy = load('C:\Users\Mohan\Documents\Visual Studio 2013\Projects\HessianResult\HessianResult\TEST1.txt');
Dy=gradient2(F,'y');
Dyy=(gradient2(Dy,'y'));
clear Dy;
...
%a = load('GaussianResult.mat');
%I = a.a;
%a=load('C:\Users\Mohan\Documents\Visual Studio 2013\Projects\SampleDFTIDFT\SampleDFTIDFT\TEST1.txt');
%I =a;
end
